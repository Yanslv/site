...
export const metadata: Metadata = { title: "Cadastrar agendamento | Painel Bendita Micro" };
...
export default async function NewManualAppointmentPage({
  ...
  return (
    <div className="max-w-2xl">
      <h1 className="mb-2 text-2xl font-semibold text-ink">Cadastrar agendamento</h1>
      <p className="mb-6 text-sm text-ink/60">
        Use para registrar solicitações recebidas por WhatsApp, Instagram, telefone ou presencialmente.
      </p>
      ...
      >
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="flex flex-col gap-1.5">
            ...
            <input id="customerName" name="customerName" required className="rounded-xl border border-surface px-3 py-2.5 text-sm" />
          </div>
          <div className="flex flex-col gap-1.5">
            <label htmlFor="customerWhatsapp" className="text-sm font-medium text-ink/80">
              WhatsApp
            </label>
            <input id="customerWhatsapp" name="customerWhatsapp" required className="rounded-xl border border-surface px-3 py-2.5 text-sm" />
          </div>
        </div>
